...
import cl.entel.tde.dtm.exception.InvalidRowSpecificationException;
import cl.entel.tde.dtm.ws.xsd.types.XSDTypes;
...
public class RowDTO {
    ...
    public String getEntityPath(){
        String enttiy = "";
        try{
            enttiy =  this.row.getCell(0).getStringCellValue();
        } catch (Exception e){
            e.printStackTrace();
        }
        return enttiy;
